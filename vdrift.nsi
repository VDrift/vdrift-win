...
Section "Install VDrift" SEC_VDRIFT
	...
	File /a /oname=libarchive-2.dll "${srcdir}\tools\win\dll\libarchive-2.dll"
	File /a /oname=libbz2-2.dll "${srcdir}\tools\win\dll\libbz2-2.dll"
	File /a /oname=libcurl.dll "${srcdir}\tools\win\dll\libcurl.dll"
	File /a /oname=libexpat-1.dll "${srcdir}\tools\win\dll\libexpat-1.dll"
	File /a /oname=liblzma-1.dll "${srcdir}\tools\win\dll\liblzma-1.dll"
	File /a /oname=libpng12-0.dll "${srcdir}\tools\win\dll\libpng12-0.dll"
	File /a /oname=libtiff.dll "${srcdir}\tools\win\dll\libtiff-3.dll"
	File /a /oname=libz-1.dll "${srcdir}\tools\win\dll\libz-1.dll"
